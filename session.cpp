...
void Session::startSession() {
    ...
    //NEED A 5 SECOND TIMER AND 64 SECOND TIMER AS WELL FOR COHERENCE SCORE AND LEVEL (LOW MED HIGH)
    //EVERY 5 SEC GET NEW COHERENCE SCORE, ALSO ADD THIS TO THE ACHEIVEMENT
}
